...
def get_vlnbert_models(args, config=None):
    ...
    model_class = NavCMT
    if args.DST:
        from models.vilmodel_cmt import NavCMT_DST
        model_class = NavCMT_DST
    ...
    # DST 
    vis_config.DST = args.DST
    vis_config.num_dst_layer = args.num_dst_layer
    vis_config.com_weight_from = args.com_weight_from
