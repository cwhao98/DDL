...
class VLNBertCMT(nn.Module):
    ...
    def forward(self, mode, txt_ids=None, txt_masks=None, txt_embeds=None, 
        ...
        if mode == 'language':
            ...
            if args.DST:
                act_logits, txt_embeds, hist_embeds, ob_embeds, obj_weight, act_weight = tt
            else:
                act_logits, txt_embeds, hist_embeds, ob_embeds = tt
            ...
            if return_states:
                ...
                if args.DST:
                    return act_logits, states, obj_weight, act_weight 
                else:
                    return act_logits, states, None, None

            if  args.DST:
                return (act_logits, obj_weight, act_weight)
            else:
                return (act_logits, None, None)
