...
def parse_args():
    ...
    parser.add_argument('--rxr_eng_only', action='store_true', default=False)

    # DST
    parser.add_argument('--train', type=str, default='None')
    parser.add_argument('--DST', action='store_true', default=False)
    parser.add_argument('--num_dst_layer', type=int, default=1)
    parser.add_argument('--com_weight_from', type=str, default='txt_hist_cls')

    parser.add_argument("--laspeaker", default=None)
    ...
    parser.add_argument('--LWeight', type=float, default=0.0)
    parser.add_argument('--AWeight', type=float, default=0.0)
    parser.add_argument("--LA_bidir", type=bool, default=False) 
    parser.add_argument("--bidir", type=bool, default=True)
    parser.add_argument('--rnn_dim', type=int, default=768)

    parser.add_argument('--pseudoWeight', type=float, default=1.0)
    parser.add_argument('--norm_la_weight', action='store_true', default=False)
    parser.add_argument('--test_ann_pse', action='store_true', default=False)
    parser.add_argument('--la_ori', action='store_true', default=False)

    parser.add_argument("--hard_la", action='store_const', default=False, const=True) 
    parser.add_argument('--hard_thd', type=float, default=0.1)
    parser.add_argument('--hard_mod', type=str, default=None)
